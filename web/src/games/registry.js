...
export const games = [
  {
    ...
    description: "Track the ball, pinch to smash, and outlast an AI rival that gets tougher with every point.",
    controls: [
  ...
  },
  {
    ...
    icon: "🎧",
    category: "RHYTHM",
    description: "Touch orbs as their rings close. Keep your combo alive to ignite FEVER.",
    controls: [
  ...
  },
  {
    ...
    icon: "🪼",
    category: "PHYSICS",
    description: "Pinch, drag, and fling jellies into a moving portal. Watch out for bomb blobs.",
    controls: [
